...
export const googleLogin = (accessToken) => api.post("/api/Auth/google-login", { accessToken });
...
export const changePassword = (id, body) => api.put(`/api/Account/${id}/change-password`, body);
